...
function closeWindow() {
  ...
  data.action = 'destroy'
  data.view = 'loginView'
  window.Electron.ipcRenderer.send("window-close", data);
}
...
<template>
  ...
  <div class="font-sans drag">
    <div class="relative min-h-screen flex flex-col sm:justify-center items-center bg-gray-100 ">
      <div class="relative sm:max-w-sm w-full app">
            ...
            <div class="mt-7 flex">
              <label for="remember_me" class="inline-flex items-center w-full cursor-pointer">
                <input id="remember_me" type="checkbox"
                       class="rounded px-4 focus:outline-none border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                       name="remember">
